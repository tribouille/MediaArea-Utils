...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get?id=0" '{"POLICY_GET_RESULT": {"policy": {"type": "and", "id": 0, "description": "", "parent_id": -1, "name": "New policy", "kind": "XSLT", "is_system": false, "children":[]}}}' "pass get policies"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "and", "id": 0, "description": "", "parent_id": -1, "name": "New policy", "kind": "XSLT", "is_system": false, "children":[]}]}}' "pass get policies"
...
test_with_curl_data "http://0.0.0.0:4242/1.7/policy_change_info" '{"POLICY_CHANGE_INFO":{"id": 0, "name": "changed name", "description": "changed description"}}' '{"POLICY_CHANGE_INFO_RESULT": {}}' "pass change info"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_name?id=0" '{"POLICY_GET_NAME_RESULT": {"name": "changed name"}}' "pass get name"
test_with_curl_data "http://0.0.0.0:4242/1.7/policy_change_type" '{"POLICY_CHANGE_TYPE":{"id": 0, "type": "or"}}' '{"POLICY_CHANGE_TYPE_RESULT": {}}' "pass change type"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "or", "parent_id": -1, "name": "changed name", "description": "changed description", "kind": "XSLT", "id": 0, "is_system": false, "children":[]},{"type": "and", "id": 1, "description": "", "parent_id": -1, "name": "New policy 1", "kind": "XSLT", "is_system": false, "children":[]}]}}' "pass get policies"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies?format=JSTREE" '{"POLICY_GET_POLICIES_RESULT": "{\"policiesTree\":[{\"id\":\"u_p\",\"text\":\"User policies\",\"type\":\"up\",\"state\":{\"opened\":true,\"selected\":true},\"children\":[{\"text\":\"changed name (or)\",\"type\":\"u\",\"data\":{\"policyId\":0,\"kind\":\"XSLT\",\"type\":\"or\",\"isEditable\":true,\"description\":\"changed description\"},\"children\":[]},{\"text\":\"New policy 1 (and)\",\"type\":\"u\",\"data\":{\"policyId\":1,\"kind\":\"XSLT\",\"type\":\"and\",\"isEditable\":true,\"description\":\"\"},\"children\":[]}]},{\"id\":\"s_p\",\"text\":\"System policies\",\"type\":\"sp\",\"state\":{\"opened\":true},\"children\":[]}]}"}' "pass get policies"
...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies?id=1" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "and", "id": 1, "description": "", "kind": "XSLT", "parent_id": -1, "name": "New policy 1", "is_system": false, "children":[]}]}}' "pass get policies"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get?id=0&format=JSTREE" '{"POLICY_GET_RESULT": "{\"policyTree\":{\"text\":\"changed name (or)\",\"type\":\"u\",\"data\":{\"policyId\":0,\"kind\":\"XSLT\",\"type\":\"or\",\"isEditable\":true,\"description\":\"changed description\"},\"children\":[]}}"}' "pass get policy"
...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "and", "id": 12, "description": "", "parent_id": -1, "kind": "XSLT", "name": "New policy_copy", "is_system": false, "children":[]}]}}' "pass get policies"
...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies":[{"name": "New policy", "description": "", "parent_id": -1, "id": 13, "kind": "XSLT", "is_system": false, "type": "and", "children":[{"ope": "", "field": "", "name": "New Rule", "id": 16, "occurrence": -1, "tracktype": "", "value": ""},{"ope": "is_equal", "field": "Format", "name": "General Format is Matroska", "id": 17, "occurrence": -1, "tracktype": "General", "value": "Matroska"}]}]}}' "pass get policies"
test_with_curl "http://0.0.0.0:4242/1.7/policy_get?id=13" '{"POLICY_GET_RESULT": {"policy":{"name": "New policy", "description": "", "parent_id": -1, "id": 13, "kind": "XSLT", "is_system": false, "type": "and", "children":[{"ope": "", "field": "", "name": "New Rule", "id": 16, "occurrence": -1, "tracktype": "", "value": ""},{"ope": "is_equal", "field": "Format", "name": "General Format is Matroska", "id": 17, "occurrence": -1, "tracktype": "General", "value": "Matroska"}]}}}' "pass get policy"
