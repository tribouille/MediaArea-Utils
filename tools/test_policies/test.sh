...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "or", "parent_id": -1, "name": "changed name", "description": "changed description", "kind": "XSLT", "id": 0, "is_system": false},{"type": "and", "id": 1, "description": "", "parent_id": -1, "name": "New policy 1", "kind": "XSLT", "is_system": false}]}}' "pass get policies"
...
test_with_curl "http://0.0.0.0:4242/1.7/policy_get_policies" '{"POLICY_GET_POLICIES_RESULT": {"policies": [{"type": "and", "id": 12, "description": "", "parent_id": -1, "kind": "XSLT", "name": "New policy_copy", "is_system": false}]}}' "pass get policies"
